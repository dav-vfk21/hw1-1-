...
?> 
 <html>
    <head>
      <title>Film più aggiunti </title>
      <meta name="viewport" content="width=device-width,initial-scale=1" >
    <link rel="stylesheet" href="most_add_film.css">
    <script src ="most_add_film.js" defer></script>
...
<body>
    ...
    <main>
        <section class="most_add_film">
          <div class="sezione_film">
             <h1>I film più aggiunti</h1>
             <h2>I film più aggiunti di sempre</h2>
           </div>
    <?php
       $apiKey = '8394c5526d833373a7389670d508ee9f';   

       $url = "https://api.themoviedb.org/3/movie/popular?page=$page&language=it-IT&api_key=$apiKey";
       $conta_poster = 0;
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='most_add_film.php?&page=$prev' class='pagina_sinistra'><img src='precedente.png'>Precedente</a>";
}
$next = $page + 1;
echo "<a href='most_add_film.php?&page=$next' class='pagina_destra'>Successiva <img src='successivo.png'></a>";
echo "</div>";
    }
} else {
