...
?>  
  <html>
    <head>
      <title>Serie TV più aggiunte </title>
      <meta name="viewport" content="width=device-width,initial-scale=1" >
    <link rel="stylesheet" href="most_watch_series_lasthour.css">
    <script src ="most_watch_series_lasthour.js" defer></script>
...
<body>
                       ...
                       <div class="dropdown_generi">
                        <div id="generi"><strong id="generi_scelta">Generi</strong></div>
                            ...
                            <div id="pulsante_giu_generi" class="hidden3">
                                ...
                                <a href="commedia_romantica">Commedia romantica</a>
    ...
    <main>
        <section class="most_add_series">
          <div class="sezione_serie">
             <h1>Serie TV più viste</h1>
             <h2>Le serie più viste nelle ultime 24 ore</h2>
           </div>
             <?php
       $apiKey = '8394c5526d833373a7389670d508ee9f';
       $timeWindow = 'day';
       $url = "https://api.themoviedb.org/3/tv/popular?page=$page&language=it-IT&api_key=$apiKey";
       $conta_poster = 0;
...
if ($controllo_bool) {
    ...
    foreach ($data['results'] as $item) {
        ...
        echo "<div class='item'>";
        echo "<a href='info.php?&tipo=serie&id=$id&title=$title'><img src='$poster' value='$title'></a>";
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='most_watch_series_lasthour.php?&page=$prev' class='pagina_sinistra'><img src='precedente.png'>Precedente</a>";
}
$next = $page + 1;
echo "<a href='most_watch_series_lasthour.php?&page=$next' class='pagina_destra'>Successiva <img src='successivo.png'></a>";
echo "</div>";
    }
} else {
