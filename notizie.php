    ...
    <main>
        <section class="mostra_generi">
          <div class="generi_serie_film">
             <h1>Generi<span>/</span>Notizie</h1>
              <?php  
             echo "<div class='scelta_generi'>";
            echo  "<div class='flex_scelta_generi'>";
            if ($tipo == 'serie') {
               echo "<a id='series' class='active' href='notizie.php?tipo=serie'>Serie</a>";
               echo "<a id='films' href='notizie.php?tipo=film'>Film</a>";
            } elseif ($tipo == 'film') {
               echo "<a id='series' href='notizie.php?tipo=serie'>Serie</a>";
               echo "<a id='films' class='active' href='notizie.php?tipo=film'>Film</a>";
            } else {
               echo "<a id='series' class='active' href='notizie.php?tipo=serie'>Serie</a>";
               echo "<a id='films' href='notizie.php?tipo=film'>Film</a>";
            }
...
if ($tipo === 'film' && isset($generi_film['notizie']) && $generi_film['notizie'] !== null) {
    $genere_id = $generi_film['notizie'];
} elseif (($tipo === 'serie' || $tipo === '') && isset($generi_serie['notizie'])) {
    $genere_id = $generi_serie['notizie'];
}
if ($genere_id !== null) {
    if ($tipo == 'serie' || $tipo == '') {
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='notizie.php?tipo=$tipo&page=$prev' class='pagina_destra'><img src='precedente.png'>Precedente</a>";
}

$next = $page + 1;
echo "<a href='notizie.php?tipo=$tipo&page=$next' class='pagina_sinistra'>Successiva <img src = 'successivo.png'</a>";
echo "</div>";
     }
} else {
