...
?>  
  <html>
    <head>
      <title>Serie TV più viste </title>
      <meta name="viewport" content="width=device-width,initial-scale=1" >
    <link rel="stylesheet" href="most_watch_series.css">
    <script src ="most_watch_series.js" defer></script>
    ...
    <main>
        <section class="most_add_series">
          <div class="sezione_serie">
             ...
             <h2>Le serie con più visualizzazioni negli ultimi 3 giorni</h2>
           </div>
            <?php
       $apiKey = '8394c5526d833373a7389670d508ee9f';
       $timeWindow = 'day';
       $conta_poster = 0;
       $url = "https://api.themoviedb.org/3/trending/tv/$timeWindow?page=$page&language=it-IT&pa&api_key=$apiKey";
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='most_watch_series.php?&page=$prev' class='pagina_sinistra'><img src='precedente.png'>Precedente</a>";
}
$next = $page + 1;
echo "<a href='most_watch_series.php?&page=$next' class='pagina_destra'>Successiva <img src='successivo.png'></a>";
echo "</div>";
    }
} else {
