...
?> 
  <html>
    ...
    <link rel="stylesheet" href="most_add_series.css">
    <script src ="most_add_series.js" defer></script>
    ...
    <main>
        <section class="most_add_series">
          <div class="sezione_serie">
             <h1>Serie TV più aggiunte</h1>
             <h2>Le serie più aggiunte di sempre</h2>
           </div>
             <?php
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='most_add_series.php?&page=$prev' class='pagina_sinistra'><img src='precedente.png'>Precedente</a>";
}
$next = $page + 1;
echo "<a href='most_add_series.php?&page=$next' class='pagina_destra'>Successiva <img src='successivo.png'></a>";
echo "</div>";
    }
} else {
