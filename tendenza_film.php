...
?> 
  <html>
    <head>
      <title>Film di Tendenza </title>
      <meta name="viewport" content="width=device-width,initial-scale=1" >
    <link rel="stylesheet" href="tendenza_film.css">
    <script src ="tendenza_film.js" defer></script>
...
<body>
    ...
    <main>
        <section class="mostra_film_tendenza">
          <div class="sezione_film">
             <h1>Film di tendenza</h1>
             <h2>Film con più reazioni negli ultimi 3 giorni</h2>
           </div>
            <?php
       ...
       $url = "https://api.themoviedb.org/3/trending/movie/$timeWindow?page=$page&language=it-IT&api_key=$apiKey";
...
if ($controllo_bool) {
    ...
    foreach ($data['results'] as $item) {
        ...
        echo "<div class='item'>";
        echo "<a href='info.php?&tipo=film&id=$id&title=$title'><img src='$poster' value='$title'></a>";
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='tendenza_film.php?&page=$prev' class='pagina_sinistra'><img src='precedente.png'>Precedente</a>";
}
$next = $page + 1;
echo "<a href='tendenza_film.php?&page=$next' class='pagina_destra'>Successiva <img src='successivo.png'></a>";
echo "</div>";
    }
} else {
