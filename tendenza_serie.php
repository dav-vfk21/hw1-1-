...
?>
    <html>
    <head>
      <title>Serie TV di Tendenza </title>
      <meta name="viewport" content="width=device-width,initial-scale=1" >
    <link rel="stylesheet" href="tendenza_serie.css">
...
<body>
    ...
    <main>
        <section class="mostra_serie_tendenza">
          <div class="sezione_serie">
             <h1>Serie TV di tendenza</h1>
             <h2>Serie con più reazioni negli ultimi 3 giorni</h2>
           </div>
   <?php
       ...
       $url = "https://api.themoviedb.org/3/trending/tv/$timeWindow?language=it-IT&api_key=$apiKey&page=$page";
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='tendenza_serie.php?&page=$prev' class='pagina_sinistra'><img src='precedente.png'>Precedente</a>";
}
$next = $page + 1;
echo "<a href='tendenza_serie.php?&page=$next' class='pagina_destra'>Successiva <img src='successivo.png'></a>";
echo "</div>";
        }
} else {
