    ...
    <main>
        <section class="mostra_generi">
          <div class="generi_serie_film">
             <h1>Generi<span>/</span>Western</h1>
              <?php  
             echo "<div class='scelta_generi'>";
            echo  "<div class='flex_scelta_generi'>";
            if ($tipo == 'serie') {
               echo "<a id='series' class='active' href='western.php?tipo=serie'>Serie</a>";
               echo "<a id='films' href='western.php?tipo=film'>Film</a>";
            } elseif ($tipo == 'film') {
               echo "<a id='series' href='western.php?tipo=serie'>Serie</a>";
               echo "<a id='films' class='active' href='western.php?tipo=film'>Film</a>";
            } else {
               echo "<a id='series' class='active' href='western.php?tipo=serie'>Serie</a>";
               echo "<a id='films' href='western.php?tipo=film'>Film</a>";
            }
...
if ($tipo === 'film' && isset($generi_film['western']) && $generi_film['western'] !== null) {
    $genere_id = $generi_film['western'];
} elseif (($tipo === 'serie' || $tipo === '') && isset($generi_serie['western'])) {
    $genere_id = $generi_serie['western'];
}
if ($genere_id !== null) {
    if ($tipo == 'serie' || $tipo == '') {
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='western.php?tipo=$tipo&page=$prev' class='pagina_destra'><img src='precedente.png'>Precedente</a>";
}
$next = $page + 1;
echo "<a href='western.php?tipo=$tipo&page=$next' class='pagina_sinistra'>Successiva <img src = 'successivo.png'</a>";
echo "</div>";
    }
} else {
