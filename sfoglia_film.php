...
<link href="https://fonts.googleapis.com/css2?family=Gidole&display=swap" rel="stylesheet">
    ...
    <body>
        <nav>
            <img src="tvtime-logo.png">        
               <div class = "show_list">
            <a href = 'film.php'><img src = 'precedente.png'></a><h2>Scopri di più</h2>
               </div>
                         <?php  
    ...
    <main>
        ...
        $url = "https://api.themoviedb.org/3/discover/$endpoint?api_key=$api_key&language=it-IT&page=$page";
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='sfoglia_film.php?tipo=$tipo&page=$prev' class='pagina_destra'><img src='precedente.png'>Precedente</a>";
}

$next = $page + 1;
echo "<a href='sfoglia_film.php?tipo=$tipo&page=$next' class='pagina_sinistra'>Successiva <img src = 'successivo.png'></a>";
echo "</div>";
      ?>
