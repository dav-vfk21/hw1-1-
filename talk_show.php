    ...
    <main>
        <section class="mostra_generi">
          <div class="generi_serie_film">
             <h1>Generi<span>/</span>Talk Show</h1>
              <?php  
             echo "<div class='scelta_generi'>";
            echo  "<div class='flex_scelta_generi'>";
            if ($tipo == 'serie') {
               echo "<a id='series' class='active' href='talk_show.php?tipo=serie'>Serie</a>";
               echo "<a id='films' href='talk_show.php?tipo=film'>Film</a>";
            } elseif ($tipo == 'film') {
               echo "<a id='series' href='talk_show.php?tipo=serie'>Serie</a>";
               echo "<a id='films' class='active' href='talk_show.php?tipo=film'>Film</a>";
            } else {
               echo "<a id='series' class='active' href='talk_show.php?tipo=serie'>Serie</a>";
               echo "<a id='films' href='talk_show.php?tipo=film'>Film</a>";
            }
...
if ($tipo === 'film' && isset($generi_film['talk_show']) && $generi_film['talk_show'] !== null) {
    $genere_id = $generi_film['talk_show'];
} elseif (($tipo === 'serie' || $tipo === '') && isset($generi_serie['talk_show'])) {
    $genere_id = $generi_serie['talk_show'];
}
if ($genere_id !== null) {
    if ($tipo == 'serie' || $tipo == '') {
...
if ($page > 1) {
    $prev = $page - 1;
    echo "<a href='talk_show.php?tipo=$tipo&page=$prev' class='pagina_destra'><img src='precedente.png'>Precedente</a>";
}

$next = $page + 1;
echo "<a href='talk_show.php?tipo=$tipo&page=$next' class='pagina_sinistra'>Successiva <img src = 'successivo.png'</a>";
echo "</div>";
    }
} else {
